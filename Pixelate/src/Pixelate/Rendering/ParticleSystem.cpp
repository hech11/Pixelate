...
namespace Pixelate {
	...
	void ParticleSystem::Emit(const ParticleProperties& props) {
		...
		particle.Velocity.x += Pixelate::Random::GetRandomInRange(props.VelocityVariation1.x, props.VelocityVariation2.x);
		particle.Velocity.y += Pixelate::Random::GetRandomInRange(props.VelocityVariation1.y, props.VelocityVariation2.y);
		...
		particle.SizeBegin += Pixelate::Random::GetRandomInRange(Pixelate::Random::GetRandomInRange(0.0f, props.SizeVariation), props.SizeVariation);
	...
	void ParticleSystem::Emit(const ParticleProperties& props) {
		...
		particle.Velocity[m_PoolIndex].x += Pixelate::Random::GetRandomInRange(props.VelocityVariation1.x, props.VelocityVariation2.x);
		particle.Velocity[m_PoolIndex].y += Pixelate::Random::GetRandomInRange(props.VelocityVariation1.y, props.VelocityVariation2.y);
		...
		particle.SizeBegin[m_PoolIndex] = props.SizeBegin + Pixelate::Random::GetRandomInRange(Pixelate::Random::GetRandomInRange(0.0f, props.SizeVariation), props.SizeVariation);
