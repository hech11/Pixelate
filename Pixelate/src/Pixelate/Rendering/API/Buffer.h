...
namespace Pixelate {
	...
	static unsigned int BufferLayoutDataTypeSize(BufferLayoutTypes type)
	{
		...
		PX_ASSERT(false, "Unknown Buffer layout data type!");
		return 0;
	}



	struct PX_API BufferElement {
		...
		unsigned int GetComponentCount() const
		{
			...
			PX_ASSERT(false, "Unknown component count!");
			return 0;
		}
	...
	class PX_API VertexBuffer {
		public :
			...
			virtual void SetLayout(const Pixelate::BufferLayout& layout) = 0;
