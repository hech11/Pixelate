...
/* 
	All window events that PX uses :
...
namespace Pixelate {
	...
	class PX_API WindowLosedFocusEvent : public Event {
		public:
	...
	class PX_API WindowGainedFocusEvent : public Event {
		public:
	...
	class PX_API WindowMovedEvent: public Event {
		private :
