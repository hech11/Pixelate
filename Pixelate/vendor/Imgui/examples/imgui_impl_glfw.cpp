...
static Pixelate::Window::EventCallbackFncPtr s_PXCallback;
void ImGui::InstallImguiCallbacks(const Pixelate::Window::EventCallbackFncPtr& callback) {
    s_PXCallback = callback;
}
