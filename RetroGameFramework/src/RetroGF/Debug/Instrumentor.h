...
namespace RGF {
	...
	// NOTE: This class does not use RGF's timer as RGF's timer does not support micro seconds!
...
#define RGF_PROFILE 1
		...
		#define RGF_PROFILE_FUNCTION() RGF_PROFILE_SCOPE(__FUNCSIG__)

	#else
		#define RGF_PROFILE_BEGIN_SESSION(name, filepath)
		#define RGF_PROFILE_END_SESSION(name, filepath)
		#define RGF_PROFILE_SCOPE(name)
		#define RGF_PROFILE_FUNCTION()
